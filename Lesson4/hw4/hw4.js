...
//
// let user=[];
// user.push(new User(1,'Dima','Ivanov','dim@gmail.com','0673874747'));
// user.push(new User(2,'Rima','Ivanova','rima@gmail.com','0678462233'));
// user.push(new User(3,'Vova','Petrov','vova@gmail.com','0673870564'));
// user.push(new User(4,'Vika','Petrova','vika@gmail.com','0679889393'));
// user.push(new User(5,'Ira','Sidorova','ira@gmail.com','0671237878'));
// user.push(new User(6,'Vasya','Vasin','vasya@gmail.com','0677874848'));
// user.push(new User(7,'Kolya','Usenko','kolya@gmail.com','0672873478'));
// user.push(new User(8,'Sima','Simenko','sima@gmail.com','0675578493'));
// user.push(new User(9,'Dasha','Pupkina','dasha@gmail.com','0683645457'));
// user.push(new User(10,'Petya','Pupkin','petya@gmail.com','0673667587'));
//
// console.log(user);
